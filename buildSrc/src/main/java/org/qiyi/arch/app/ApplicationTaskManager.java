...
public class ApplicationTaskManager extends TaskManager {
    ...
    public void createTasksForVariantScope(@NonNull final VariantScope variantScope) {
        ...
        createDataBindingTasksIfNecessary(variantScope, com.android.build.gradle.internal.TaskManager.MergeType.MERGE);
    ...
    @NonNull
    @Override
    protected Set<? super QualifiedContent.Scope> getResMergingScopes(@NonNull VariantScope variantScope) {
